...
| `npm run latency` | Measures the operations that touch every note, and fails if the shape regresses |
| `npm run check:all` | Everything CI runs, including the browser suite |
